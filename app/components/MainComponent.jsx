                    ...
                    return (
                      <>
                        <div className="card self-center max-w-72  rounded-lg overflow-hidden shadow-lg mb-10  cursor-pointer " style={{ backgroundColor: '#111', maxHeight: '600px' }}>
                          <img src={product.image} alt={product.title} className="w-full max-h-96 min-h-96 object-cover" />
              ...
              <>
                <div className="flex items-center justify-center mt-10">
                  ...
                  <div class="text-center">
                    <div
                      class="w-16 h-16 border-4 border-dashed rounded-full animate-spin  border-white mx-auto"
                    ></div>
                    <h2 class="text-zinc-900 dark:text-white mt-4">Loading Products...</h2>
